...
rem     build [ msvc110 | msvc100 | msvc90 | msvc80 | msvc71 ] - Build with a given version of MS VC++

if "%1" == "clean" del *.obj *.exe build.log *.out && goto END
if "%1" == "test"  goto TEST
if "%1" == "msvc110" shift &&   call :SET_VS_VARS msvc110 && goto PROCEED
if "%1" == "msvc100" shift &&   call :SET_VS_VARS msvc100 && goto PROCEED
...
if not "%VS110COMNTOOLS%" == "" call :SET_VS_VARS msvc110 && goto PROCEED
if not "%VS100COMNTOOLS%" == "" call :SET_VS_VARS msvc100 && goto PROCEED
...
if "%1" == "msvc110" call "%VS110COMNTOOLS%vsvars32.bat" > build.log && echo Using MS Visual C++ 11.0
if "%1" == "msvc100" call "%VS100COMNTOOLS%vsvars32.bat" > build.log && echo Using MS Visual C++ 10.0
